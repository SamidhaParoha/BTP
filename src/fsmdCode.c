...
{ 
 ...
 /********************************modified write_lists function **********************************************/
 char *
write_lists1( NC *root , char * str ) //WRITE_LISTS <- for finding fast NC *root , char * str
{ 
...
/*strcat(str,'\0');
printf("  \nnew one ssssssssss i am in write list1 %s\n",str);
printf("i am in write list1 %s",str);*/
return str;
}
